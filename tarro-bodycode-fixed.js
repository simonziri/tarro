...
(function() {
  document.addEventListener('DOMContentLoaded', function() {
    // Encapsulate the logic in a function to keep it modular and safe
    function validateDropdown() {
      // Select the specific dropdown field (change 'select[name="cuisine-type"]' to match your field)
    ...
    // Call the function to activate the validation logic
    validateDropdown();
  });
})();
